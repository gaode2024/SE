<img width="1701" height="745" alt="image" src="https://github.com/user-attachments/assets/54df8f77-b6ce-48cb-b912-89bb5bd261c3" />
...
Line 233: replace 'ELSE' to 'ENDIF'
Line 275: replace 'ENDIF' to '"ENDIF'
Line 327: replace 'APPEND INITIAL LINE TO lt_plancost ASSIGNING <fs_output>.'
to
ASSIGN COMPONENT zde_cl_con_cpm_pw_util=>gc_mflg OF STRUCTURE <fs_data1> TO FIELD-SYMBOL(<fs_mflg>).
      ...
      ENDIF.
Line 348: replace '<fs_output>-plancost  = lv_plancost.' to '<fs_output>-plancost  = <fs_output>-plancost + lv_plancost.'
Line 349: replace '<fs_output>-zplan_qty = lv_plan_qty.' to '<fs_output>-zplan_qty = <fs_output>-zplan_qty + lv_plan_qty.'
Line 354: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 376: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 382: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 399: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 406: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 408: replace 'ct_plancost' to 'lt_plancost_cpm'
Line 421-426: delete lines
line 487 add: 
...
iobjnm <> zde_cl_con_cpm_pw_util=>gc_mflg

SI_TICKETS_ASYNC_IN
ZCON_PFMIE_EX_PERIOD_FACTOR
Enhance Saving financial amounts monthly

<img width="1719" height="979" alt="image" src="https://github.com/user-attachments/assets/ec37e92f-402d-4d07-b6ee-93eb45b6610d" />


zde_cl_con_cpm_pw_util=>get_demand_data
...
<img width="1731" height="757" alt="image" src="https://github.com/user-attachments/assets/c55deb96-3d43-4dd8-8152-e1b2b50ac118" />
...
https://vhriav1dci.sap.cariad.eu.sap.cloud.vwgroup.com:44300/sap/bc/ui5_ui5/sap/zcon_fri_simvc/index.html?sap-client=110
...
DATA(lo_transaction_manager) = /bobf/cl_tra_internal_tm_fctry=>get_transaction_manager( mv_bo_key ).
mo_non_cache_reg = lo_transaction_manager->mo_non_cache_reg.
    
mo_non_cache_reg = CAST /bobf/if_tra_trans_mgr_compl( lo_transaction_manager )->mo_non_cache_reg.
/bobf/cl_tra_internal_tm_fctry
